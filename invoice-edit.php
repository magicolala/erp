        ...
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box">
                            <h4 class="header-title">Modifier une facture</h4>
                            <form class="form-horizontal" method="POST" action="invoice-update.php?id=<?= $id ?>">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="reference">Reference</label>
                                    <div class="col-sm-6">
                                        <input type="text" name="reference" class="form-control" id="reference" placeholder="Reference" required value="<?= $invoice->reference ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control" id="client_id" name="client_id" required>
                                            ...
                                            <?php foreach ($clients as $client): ?>
                                                <option value="<?= $client->id ?>" <?php if ($client->id == $invoice->client_id) echo 'selected'; ?>><?= $client->firstname ?>&nbsp;<?= $client->lastname ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="number" name="totalHT" class="form-control" id="totalHT" placeholder="Total" required value="<?= $invoice->totalHT ?>">
                                    </div>
                                </div>
                                <div class="row">
