...
if ($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_POST)) {
    ...
    $sql = "INSERT INTO Provider (name, code_iso) values(?, ?)";
    $q = $db->prepare($sql);
    $q->execute(array($name, $code_iso));
    logBDD($db, 'created', "Provider");
        ...
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box">
                            <h4 class="header-title">Ajouter un fournisseur</h4>

                            <form class="form-horizontal" method="POST" action="provider-add.php">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="simpleinput">Nom</label>
                                    <div class="col-sm-6">
                                        <input type="text" name="name" class="form-control" id="simpleinput" placeholder="Nom du fournisseur" required>
                                    </div>
                                </div>
                                <div class="form-group row">
